 ...
 */
final class Version20220324171941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card ADD cvv INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE card DROP cvv, CHANGE number number VARCHAR(16) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE date date VARCHAR(7) NOT NULL COLLATE `utf8_unicode_ci`');
