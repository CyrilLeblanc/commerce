 ...
 */
final class Version20220324182121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD card_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP card_id, CHANGE status status VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`');
